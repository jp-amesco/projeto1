...
@section('content')
    ...
    <form method="POST" action="{{URL('produtos')}}">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="sku" name="sku" placeholder="Digite o Codigo do Produto..." required>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <textarea class="form-control" id="descricao" name="descricao" placeholder="Digite uma breve descrição do Produto..." required></textarea>
        </div>
